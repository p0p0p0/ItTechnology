...
public class SearchResultAdapter extends BaseAdapter {
    ...
    class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            //dingwei_layout
            mLinearLayout = (LinearLayout) view.findViewById(R.id.dingwei_layout);
        ...
        public void bindView(int position) {
            ...
            final String s = poiItem.getCityName() + poiItem.getAdName() + poiItem.getSnippet();
            textSubTitle.setText(s);
