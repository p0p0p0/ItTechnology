...
public class ServiceDetailsBean implements Serializable {
    ...
    public static class DataBean {
         ...
         * shop_name : 亿赛通
         * show_pic : [""]
         * seller_pic : data/avatar/000/00/00/20_avatar_big.jpg
         * mark_info : []
         */
