...
public class ECNotificationManager {
    ...
    public final void showCustomNewMessageNotification(Context context , String pushContent , String fromUserName , String sessionId , int lastMsgType) {
        ...
        @SuppressLint("WrongConstant") PendingIntent pendingIntent = PendingIntent.getActivity(mContext, 35, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private void cancel() {
        @SuppressLint("WrongConstant") NotificationManager notificationManager = (NotificationManager) CCPAppManager
    ...
    //    notification.setLatestEventInfo(context, kickofftext, "", pendingIntent);
        ((NotificationManager)mContext.getSystemService(Context.NOTIFICATION_SERVICE)).notify(NOTIFY_ID_PUSHCONTENT, noti);
    }
