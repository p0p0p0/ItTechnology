...
import com.safetyhuge.chanlian.safetyhuge.IM.common.view.NetWarnBannerView;
...
import com.safetyhuge.chanlian.safetyhuge.IM.ui.group.GroupService;
    ...
    final private AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View visew, int position,
            ...
            if(mAdapter != null) {
                ...
                KLog.e("whbname",conversation.getUsername());
                KLog.e("whbid",conversation.getSessionId());
