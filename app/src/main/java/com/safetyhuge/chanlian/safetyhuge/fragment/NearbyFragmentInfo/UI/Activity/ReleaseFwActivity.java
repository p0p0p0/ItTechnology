...
public class ReleaseFwActivity extends HBaseAct implements LocationSource, AMapLocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_release_layout_fw);
        ButterKnife.bind(this);
        mContext = ReleaseFwActivity.this;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.release_butto_update:
                type = 2;
                final BottomPopupOption bottomPopupOption = new BottomPopupOption(ReleaseFwActivity.this);
                ...
                bottomPopupOption.setItemClickListener(new BottomPopupOption.onPopupWindowItemClickListener() {
                    ...
                    public void onItemClick(int position) {
                        switch (position) {
                            case 0:
                                //权限判断
                                if (ContextCompat.checkSelfPermission(ReleaseFwActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                        != PackageManager.PERMISSION_GRANTED) {
                                    //申请WRITE_EXTERNAL_STORAGE权限
                                    ActivityCompat.requestPermissions(ReleaseFwActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                            ...
                            case 1:
                                //权限判断
                                if (ContextCompat.checkSelfPermission(ReleaseFwActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                                        != PackageManager.PERMISSION_GRANTED) {
                                    //申请READ_EXTERNAL_STORAGE权限
                                    ActivityCompat.requestPermissions(ReleaseFwActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
       ...
       //市
        mCity = amapLocation.getCity();
        //区
        mDistrict = amapLocation.getDistrict();*/mKProgressHUD.show();
                                                                NetWork1(mUID,mProvince,mCity,mDistrict,Phone,XmYi,XmEr,EtTitle,Describe,Money,"次",timeCount,tiem,mWeidu,mJingdu);
    ...
    public void NetWork1(String uid,
        ...
        hashMap.put("action", "NextServiceSept1");
        hashMap.put("uid", uid);
        ...
        if (mCropImagePath!=null){
            ...
            OkGo.post(RequestAddress.HOST + RequestAddress.GOODS).params(hashMap).params("upload", mFile).execute(new StringCallback() {
                ...
                public void onSuccess(String s, Call call, Response response) {
                    ...
                    if (a.equals("888")) {
                        Toasty.success(ReleaseFwActivity.this, "发布成功", Toast.LENGTH_SHORT).show();
                        SharedPrefsUtil prefsUtil = new SharedPrefsUtil();
                        prefsUtil.put(ECApplication.context,"release",false);
                        finish();
                    } else {
                        Toasty.error(ReleaseFwActivity.this, "发布失败", Toast.LENGTH_SHORT).show();
                        SharedPrefsUtil prefsUtil = new SharedPrefsUtil();
                        prefsUtil.put(ECApplication.context,"release",false);
                    }
                }
