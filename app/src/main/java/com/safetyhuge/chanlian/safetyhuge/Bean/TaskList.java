...
public class TaskList implements Serializable {
     ...
     * code : 888
     * secess : true
     * data : [{"task_id":"487","work_id":"","model_id":"5","work_count":"","single_cash":"10000.00","profit_rate":"10","task_fail_rate":"100","task_status":"8","task_title":"订金招标0329","task_desc":"阿是多孔菌科了解恶趣味哦期望对起舞请问 u案例那些支持，明年初， 满，满哪家好的借口环境空气我何苦千家万户饿啊，地方，满那些支持，m","task_file":"","task_files":"","task_pic":"","indus_id":"29","indus_pid":"2","uid":"33","username":"lvshitao","start_time":"1490769603","sub_time":"1493448003","end_time":"1493448003","sp_end_time":"1490942993","city":"37","task_cash":"20000.00","real_cash":"6000.00","task_cash_coverage":"0","cash_cost":"20000.00","credit_cost":"0.00","view_num":"7","work_num":"2","leave_num":"0","focus_num":"0","mark_num":"2","is_delineas":"0","kf_uid":"0","pay_item":"","att_cash":"0.00","contact":"18567222222","unique_num":"","ext_time":"","ext_desc":"","task_union":"0","alipay_trust":"","is_delay":"0","r_task_id":"","is_trust":"0","trust_type":"","is_top":"0","is_auto_bid":"0","point":"","payitem_time":"b:0;","age_requirement":"0","seo_title":"","seo_keyword":"","seo_desc":"","province":"1","area":"567","tasktop":"0","urgent":"0","seohide":"0","workhide":"0","budget":"20000.00","teamwork":"0","is_back":"","goldtype":"","giftname":"","lng":"","lat":"","bond_cash":"0.00","bond_rate":"0.00","cash_rule_id":"","start_cove":"","end_cove":"","cove_desc":"","on_time":"","model_code":"","favorite":false,"province_name":"北京","city_name":"东城区","area_name":"东华门街道","model_name":"订金招标","show_cash":"￥ 20000.00","show_status":"已结束"}]
     */
    ...
    public static class DataBean {
         ...
         * model_id : 5
         * work_count :
         * single_cash : 10000.00
         * profit_rate : 10
         * task_fail_rate : 100
         * task_status : 8
         * task_title : 订金招标0329
         * task_desc : 阿是多孔菌科了解恶趣味哦期望对起舞请问 u案例那些支持，明年初， 满，满哪家好的借口环境空气我何苦千家万户饿啊，地方，满那些支持，m
         * task_file :
         * task_files :
         * task_pic :
         * indus_id : 29
        ...
        private String cash_rule_id;
        private String start_cove;
        private String end_cove;
        private String cove_desc;
        ...
        public String getCash_rule_id() {
            return cash_rule_id;
        }

        public void setCash_rule_id(String cash_rule_id) {
            this.cash_rule_id = cash_rule_id;
        }

        public String getStart_cove() {
            return start_cove;
        }

        public void setStart_cove(String start_cove) {
            this.start_cove = start_cove;
        }

        public String getEnd_cove() {
            return end_cove;
        }

        public void setEnd_cove(String end_cove) {
            this.end_cove = end_cove;
        }

        public String getCove_desc() {
            return cove_desc;
        }

        public void setCove_desc(String cove_desc) {
            this.cove_desc = cove_desc;
        }
