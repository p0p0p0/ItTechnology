...
import static com.safetyhuge.chanlian.safetyhuge.fragment.NearbyFragmentInfo.UI.MineActivityInfo.MineFragmentInfo.ServiceIndent2.ACTION_NAME_SHOUCHU_PJ;

/**
 * 作者：王海宾 on 2017/4/25 0025 18:35
 * 邮箱：995696826@qq.com
 */
public class ServiceIndentPingjiaActivity extends HBaseAct {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indentpingjia);
        ...
        if (mMark_status != null) {
            if (!context.isEmpty()) {
                if (!xing1.equals("0.0") && !xing2.equals("0.0") && !xing3.equals("0.0")) {
                    NetWork(mUserid, mGoodsid, context, "4,5", xing1 + "," + xing2, mMark_status);
                } else {
