...
import com.safetyhuge.chanlian.safetyhuge.IM.common.utils.ResourceHelper;
...
import com.safetyhuge.chanlian.safetyhuge.IM.storage.GroupMemberSqlManager;
import com.safetyhuge.chanlian.safetyhuge.IM.storage.GroupNoticeSqlManager;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.base.EmojiconTextView;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.model.Conversation;
...
public class ConversationAdapter extends CCPListAdapter<Conversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        KLog.e("whb",conversation.getUsername());
        if(conversation != null) {
            ...
            if(conversation.getSessionId().toUpperCase().startsWith("G")) {
                ...
                if(conversation.getMsgType() == 1000) {
                    ...
                    KLog.e("whb",conversation.getSessionId());
                    KLog.e("whb",contact.getRemark());
                    //设置头像
