...
import com.safetyhuge.chanlian.safetyhuge.IM.ui.ECFragmentActivity;
...
//		bundle.putString(ChattingFragment.RECIPIENTS,getIntent().getStringExtra(ChattingFragment.RECIPIENTS));
//		bundle.putString(ChattingFragment.CONTACT_USER,getIntent().getStringExtra(ChattingFragment.CONTACT_USER));
