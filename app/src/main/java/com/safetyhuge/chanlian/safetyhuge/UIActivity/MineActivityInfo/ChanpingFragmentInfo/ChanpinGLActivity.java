 ...
 * 邮箱：995696826@qq.com
 */
public class ChanpinGLActivity extends HBaseAct {
    ...
    private void initView() {
        ...
        //获取fragment工厂对象
        ChanpingMainPagerAdater pagerAdater = new ChanpingMainPagerAdater(getSupportFragmentManager(), 0);
        //填充Viewpager
