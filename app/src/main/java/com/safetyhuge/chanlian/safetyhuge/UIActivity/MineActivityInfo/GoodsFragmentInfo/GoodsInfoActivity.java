...
public class GoodsInfoActivity extends HBaseAct {
    ...
    private void initView() {
        ...
        //获取fragment工厂对象
        GoodsMainPagerAdater pagerAdater = new GoodsMainPagerAdater(getSupportFragmentManager(), 0);
        //填充Viewpager
