...
/**收藏管理
 * 作者：王海宾 on 2017/4/17 0017 21:55
 * 邮箱：995696826@qq.com
 */

public class MineCollectActivity extends HBaseAct {
    ...
    private void initView() {
        ...
        //获取fragment工厂对象
        CollectMainPagerAdater pagerAdater = new CollectMainPagerAdater(getSupportFragmentManager(), 0);
        //填充Viewpager
