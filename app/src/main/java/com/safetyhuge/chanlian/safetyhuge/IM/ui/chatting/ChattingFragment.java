...
import com.safetyhuge.chanlian.safetyhuge.IM.common.dialog.ECListDialog;
import com.safetyhuge.chanlian.safetyhuge.IM.common.dialog.ECProgressDialog;
import com.safetyhuge.chanlian.safetyhuge.IM.common.utils.ClipboardUtils;
import com.safetyhuge.chanlian.safetyhuge.IM.common.utils.DemoUtils;
...
import com.safetyhuge.chanlian.safetyhuge.IM.common.utils.EmoticonUtil;
import com.safetyhuge.chanlian.safetyhuge.IM.common.utils.FileAccessor;
import com.safetyhuge.chanlian.safetyhuge.IM.common.utils.FileUtils;
import com.safetyhuge.chanlian.safetyhuge.IM.common.utils.LogUtil;
import com.safetyhuge.chanlian.safetyhuge.IM.common.utils.MediaPlayTools;
import com.safetyhuge.chanlian.safetyhuge.IM.common.utils.ToastUtil;
import com.safetyhuge.chanlian.safetyhuge.IM.core.ECAsyncTask;
import com.safetyhuge.chanlian.safetyhuge.IM.photopicker.PhotoPickerActivity;
import com.safetyhuge.chanlian.safetyhuge.IM.pojo.ImUserState;
import com.safetyhuge.chanlian.safetyhuge.IM.storage.ContactSqlManager;
import com.safetyhuge.chanlian.safetyhuge.IM.storage.ConversationSqlManager;
import com.safetyhuge.chanlian.safetyhuge.IM.storage.GroupSqlManager;
import com.safetyhuge.chanlian.safetyhuge.IM.storage.IMessageSqlManager;
import com.safetyhuge.chanlian.safetyhuge.IM.storage.ImgInfoSqlManager;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.CCPFragment;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.LocationInfo;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.SDKCoreHelper;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.base.ECPullDownView;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.base.OnListViewBottomListener;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.base.OnListViewTopListener;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.base.OnRefreshAdapterDataListener;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.model.ImgInfo;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.view.CCPChattingFooter2;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.view.SmileyPanel;
import com.safetyhuge.chanlian.safetyhuge.IM.ui.contact.AtSomeoneUI;
...
public class ChattingFragment extends CCPFragment implements
	...
	/** 消息发送者头像地址 */
	public static final String Sender_ImageUrl = "Sender_ImageUrl";
	/** 消息接收者name */
	public static final String Receiver_NickName = "Receiver_NickName";
	/** 消息接收者头像地址 */
	public static final String Receiver_ImageUrl = "Receiver_ImageUrl";
	private String mStringExtra;
	private String mStringExtra1;
	private String mStringExtra2;
	private String mStringExtra3;
    ...
    private void initActivityState(Bundle savedInstanceState) {
		...
		mStringExtra = intent.getStringExtra(Sender_NickName);
		mStringExtra1 = intent.getStringExtra(Sender_ImageUrl);
		mStringExtra2 = intent.getStringExtra(Receiver_NickName);
		mStringExtra3 = intent.getStringExtra(Receiver_ImageUrl);
	...
	public String toString() {
		return "ChattingFragment{" +
				"mStringExtra='" + mStringExtra + '\'' +
				", mStringExtra1='" + mStringExtra1 + '\'' +
				", mStringExtra2='" + mStringExtra2 + '\'' +
				", mStringExtra3='" + mStringExtra3 + '\'' +
				'}';
	}
    ...
    private void handleSendTextMessage(CharSequence text) {
		...
		try {
			array.put("Notification_Message_Sender_NickName",mStringExtra);
			array.put("Notification_Message_Sender_ImageUrl", RequestAddress.IMAGE1+mStringExtra1);
			array.put("Notification_Message_Receiver_NickName",mStringExtra2);
			array.put("Notification_Message_Receiver_ImageUrl",mStringExtra3);
		} catch (JSONException e) {
			e.printStackTrace();
		}
		msg.setUserData(array.toString());
		KLog.e("array",array.toString());
