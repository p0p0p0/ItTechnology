...
public class ServiceHelp1Activity extends HBaseAct {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qiuzhu1);
        ButterKnife.bind(this);
        mUserid = (String) SharedPrefsUtil.get(ECApplication.context, "UserUid", "");
        mProgressHUD = KProgressHUD.create(ServiceHelp1Activity.this)
    ...
    private void initView() {
     ...
     /*   //id
        ...
        if (status.equals("已完成")) {
            ...
            mQiuzhu1Layout1Button.setText("等待买家付款");
            mQiuzhu1Layout1Button.setClickable(false);
        } else if (status.equals("待确认")) {
            mQiuzhu1Layout1Button.setText("等待买家确认完成");
            mQiuzhu1Layout1Button.setClickable(false);
            ...
            mQiuzhu1Layout1Button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mMaterialDialog = new MaterialDialog(ServiceHelp1Activity.this)
                            .setTitle("提示")
            ...
            mQiuzhu1Layout1Button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(ServiceHelp1Activity.this, PingjiaActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.qiuzhu1_layout2_button1:
                ...
                break;
            //同意接单
            case R.id.qiuzhu1_layout1_button:
                mMaterialDialog = new MaterialDialog(this)
                        .setTitle("提示")
                        .setMessage("你确定同意接单?")
                        .setPositiveButton("确定", new View.OnClickListener() {
            ...
            public void onSuccess(String s, Call call, Response response) {
                ...
                if (code.equals("888") && secess.equals("true")) {
                    if (flag == 0) {
                        ...
                        mQiuzhu1Layout1Button.setText("等待对方确认完成");
                        ...
                        sendBroadCastRefreshMainMeUniversity("com.help.wancheng",mItem);
                    }
                } else {
