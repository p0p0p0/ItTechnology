 ...
 * 邮箱：995696826@qq.com
 */
public class FananGlActivity  extends HBaseAct {
    ...
    private void initView() {
        ...
        //获取fragment工厂对象
        FananMainPagerAdater pagerAdater = new FananMainPagerAdater(getSupportFragmentManager(), 0);
        //填充Viewpager
