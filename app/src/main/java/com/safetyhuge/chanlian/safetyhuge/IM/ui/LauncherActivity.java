 ...
 */
package com.safetyhuge.chanlian.safetyhuge.IM.ui;
...
import com.safetyhuge.chanlian.safetyhuge.IM.common.ECContentObservers;
import com.safetyhuge.chanlian.safetyhuge.IM.common.base.CCPCustomViewPager;
import com.safetyhuge.chanlian.safetyhuge.IM.common.base.CCPLauncherUITabView;
import com.safetyhuge.chanlian.safetyhuge.IM.common.base.OverflowAdapter;
import com.safetyhuge.chanlian.safetyhuge.IM.common.base.OverflowAdapter.OverflowItem;
...
import com.safetyhuge.chanlian.safetyhuge.IM.storage.GroupNoticeSqlManager;
...
import com.safetyhuge.chanlian.safetyhuge.IM.ui.chatting.CustomerServiceHelper;
...
import com.safetyhuge.chanlian.safetyhuge.IM.ui.settings.SettingsActivity;
import com.safetyhuge.chanlian.safetyhuge.R;
import com.safetyhuge.chanlian.safetyhuge.UIActivity.Activity.MinInfoActivity;
...
public class LauncherActivity extends ECFragmentActivity implements
    ...
    private void initView() {
        final String mUserid = (String) SharedPrefsUtil.get(ECApplication.getInstance(), "UserUid", "");
        ...
        LinearLayout layout = (LinearLayout) findViewById(R.id.mimsg_layout1);
        TextView textView = (TextView) findViewById(R.id.mimsg_content);
        TextView mimsg_time = (TextView) findViewById(R.id.mimsg_time);
        layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LauncherActivity.this, MinInfoActivity.class);
                intent.putExtra("id", mUserid);
                startActivity(intent);
            }
        });
        NetWork(mKProgressHUD, mUserid, textView, layout, mimsg_time);
    }

    public void NetWork(final KProgressHUD mKProgressHUD, String mUserid, final TextView textView, final LinearLayout layout, final TextView mimsg_time) {
        OkGo.post(RequestAddress.HOST + "xiaoxi.php").params("to_uid", mUserid).execute(new JsonCallback<MsgBean>() {
            ...
            public void onSuccess(MsgBean msgBean, Call call, Response response) {
                ...
                if (mData != null) {
                    textView.setText(mData.get(0).getTitle());
                    mimsg_time.setText(DateUtils.timesTwo(mData.get(0).getOn_time()));
                } else {
    ...
    protected void onResume() {
        ...
        if (fullExit) {
            try {
                ...
                ECDevice.unInitial();
                LogUtil.e("NewLauncherActivity11111");
                finish();
        ...
        if (mLauncherUITabView == null) {
            ...
            if (TextUtils.isEmpty(account)) {
                LogUtil.e("NewLauncherActivity222222");
               // finish();
