 ...
 * 全部订单的fragment
 */
public class SaleGoodsMainPagerAdater extends FragmentPagerAdapter {
    //标题数组
    ...
    public SaleGoodsMainPagerAdater(FragmentManager fm, int i) {
        super(fm);
        this.i = i;
    ...
    public Fragment getItem(int position) {
        if (i == 0) {
            return SaleGoodsFragmentFactory.create(position);
        } else if (i == 1) {
            return SaleGoodsFragmentFactory.create(position);
        } else if (i == 2) {
            return SaleGoodsFragmentFactory.create(position);
