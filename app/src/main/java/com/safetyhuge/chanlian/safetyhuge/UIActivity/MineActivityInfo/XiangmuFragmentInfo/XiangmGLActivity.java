 ...
 * 邮箱：995696826@qq.com
 */
public class XiangmGLActivity extends HBaseAct {
    ...
    private void initView() {
        ...
        //获取fragment工厂对象
        XiangmuMainPagerAdater pagerAdater = new XiangmuMainPagerAdater(getSupportFragmentManager(), 0);
        //填充Viewpager
