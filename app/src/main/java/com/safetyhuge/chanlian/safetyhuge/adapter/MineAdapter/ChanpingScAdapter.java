 ...
 * 邮箱：995696826@qq.com
 */
public class ChanpingScAdapter extends BaseAdapter {
    List<ChanpingBean.DataBean> dataBeen;
    FragmentActivity activity;
    public ChanpingScAdapter(List<ChanpingBean.DataBean> dataBeen, FragmentActivity activity) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView = View.inflate(context, R.layout.item_chanpingsc, null);
