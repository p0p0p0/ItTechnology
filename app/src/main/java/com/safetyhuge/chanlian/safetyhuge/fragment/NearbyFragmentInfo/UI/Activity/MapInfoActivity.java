...
/**
 * 作者：王海宾 on 2017/5/17 0017 15:12
 * 邮箱：995696826@qq.com
 */
public class MapInfoActivity extends HBaseAct implements LocationSource,
   ...
   // public static String
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dingweimain);
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(MapInfoActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    ...
                    Inputtips inputTips = new Inputtips(MapInfoActivity.this, inputquery);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(MapInfoActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(MapInfoActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(MapInfoActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position != searchResultAdapter.getSelectedPosition()) {
                ...
                String s = poiItem.getCityName() + poiItem.getAdName() + poiItem.getSnippet();
                LatLng curLatlng = new LatLng(poiItem.getLatLonPoint().getLatitude(), poiItem.getLatLonPoint().getLongitude());
                KLog.e("curLatlng","经度"+poiItem.getLatLonPoint().getLongitude()+"纬度"+poiItem.getLatLonPoint().getLatitude());
                KLog.e("地址",s);
                ...
                sharedPrefsUtil.put(ECApplication.context,"jingdu",poiItem.getLatLonPoint().getLongitude());
                sharedPrefsUtil.put(ECApplication.context,"weidu",poiItem.getLatLonPoint().getLatitude());
                sharedPrefsUtil.put(ECApplication.context,"dizhi",s);
                finish();
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(MapInfoActivity.this, "erroCode " + rCode , Toast.LENGTH_SHORT).show();
            }
        }
    };
